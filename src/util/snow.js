...
/*  this.snowCharacter = '&bull;'*/
  ...
  this.fallSpeed = 0.1 //Snow falling speed
  this.windLevel = 0.1//wind`s level for snow ,- for left;+ for right
  // --- End of user section ---
  ...
  var s = this, storm = this, i,
    ...
    opacitySupported = (function () {
      try {
        document.createElement('p').style.opacity = '0.5'
      } catch (e) {
        return false
      }
      return true
  ...
  this.SnowFlake = function (parent, type, x, y) {
    ...
    this.o = document.createElement('p')
    this.o.innerHTML = storm.snowCharacter
    this.o.style.color = storm.snowColor
    this.o.style.position = (fixedForEverything ? 'fixed' : 'absolute')
    let ranVal=rnd(1,0.5)
    this.o.style.width = storm.flakeWidth*ranVal + 'px'
    this.o.style.height = storm.flakeHeight*ranVal + 'px'
    ...
    this.setVelocities = function () {
      s.vX = vRndX + rnd(storm.vMaxX * 0.12,that.windLevel)
      s.vY = vRndY + rnd(storm.vMaxY * 0.12,that.fallSpeed)
    }
  ...
  this.init = function () {
    ...
    s.animationInterval = Math.max(0.1, s.animationInterval)
    s.timerInit()
  }
  ...
  if (s.autoStart) {
    s.events.add(window, 'load', doStart, true)
  }
}
